...
import spring.project.server.services.CalculateRankList;
...
public class SelectionController {
    ...
    private final CalculateRankList calculateRangList;

    public SelectionController(final SelectionService selectionService, final CalculateRankList calculateRangList) {
    ...
    private List<Match> getHostMatchesFromSelectionString(final String selectionString) throws JsonProcessingException {
        ...
        return Arrays.asList(objectMapper.readValue(hostMatchesString, Match[].class));
    }
    ...
    private List<Match> getAwayMatchesFromSelectionString(final String selectionString) throws JsonProcessingException {
        ...
        return Arrays.asList(objectMapper.readValue(awayMatchesString, Match[].class));
    }
